...
#print(method)
#print(seed)
run_experiment(datasets =[dataset], fairness_constrains=["equalized_odds"], methods=[method], file="/work/dlclarge2/fetzert-MySpace/autosklearn", seeds= [seed], sf=[sf] ,runtime = 3600)
