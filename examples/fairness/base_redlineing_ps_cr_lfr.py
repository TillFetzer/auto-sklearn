...
def run_experiment(dataset, fairness_constrain, sf, runtime, file, seed, runcount, under_folder, performance =  autosklearn.metrics.accuracy):
    ...
    autosklearn_directory = tempdir + 'dir_moo_sar_ps_cr_lfr_2_{}'.format(seed)
    ...
    # Build and fit a classifier
    # ==========================
    result_folder =  file + "/{}/{}/{}/{}/moo+sar+cr+ps+lfr/{}timesstrat".format(under_folder, fairness_constrain, dataset, seed, runcount)
    runtime = runtime
    tempdir = tempfile.mkdtemp()
