...
methods = [ 
           "moo+sar*ps", "sar+ps+cr+lfr", "moo+sar+ps+cr", "moo+sar+ps+lfr",  "moo+sar+cr+lfr"
           ]
...
#sfs = ["personal_status"]
fairness_constrains=["error_rate_difference","consistency_score","demographic_parity","equalized_odds"]
