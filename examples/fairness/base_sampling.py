...
def run_experiment(dataset, fairness_constrain, sf, runtime, 
    ...
    result_folder =  file + "/{}/{}/{}/{}/moo_ps_/{}timesstrat".format(under_folder, fairness_constrain, dataset, seed, runcount)
    runtime = runtime
    tempdir = tempfile.mkdtemp()
    autosklearn_directory = tempdir + 'dir_moo_ps_{}'.format(seed)
    ...
    #import pickle
    #with open("/home/till/Documents/auto-sklearn/tmp/moo_ps_config_space.pickle", "wb") as f:
    #    pickle.dump(cs, f)
