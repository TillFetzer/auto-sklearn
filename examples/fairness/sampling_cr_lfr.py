...
def run_experiment(dataset, fairness_constrain, sf, runtime, file, seed, runcount, under_folder, performance =  autosklearn.metrics.accuracy):
    ...
    # Build and fit a classifier
    # ==========================
    tmp =  file + "/{}/{}/{}/{}/ps+cr+lfr/{}timesstrat".format(under_folder, fairness_constrain, dataset, seed, runcount)
    runtime = runtime
    automl = autosklearn.classification.AutoSklearnClassifier(
        ...
        include={
            ...
            "fair_preprocessor": ["PreferentialSampling", "CorrelationRemover", "LFR"],
            "classifier": [
                "random_forest"
            ], 
    ...
    #import pickle
    #with open("/home/till/Documents/auto-sklearn/tmp/configspace/ps+cr+lfr_config_space.pickle", "wb") as f:
    #    pickle.dump(cs, f)
